  ...
  implements BlueprintElementBuilder
{
  ...
  appendTuple () {
    @NonNull
    final ChainedStaticTupleBlueprintBuilder<ChainedStaticTupleBlueprintBuilder<Parent>> builder = (
  ...
  appendObject () {
    @NonNull
    final ChainedStaticObjectBlueprintBuilder<ChainedStaticTupleBlueprintBuilder<Parent>> builder = (
