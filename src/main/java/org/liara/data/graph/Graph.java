...
/**
 * A data graph. A data graph is the description of some sort of database with its table, their
 * columns and their relationship. A graph is used for producing request to another data management
 * service.
 *
